  ...
  <section id="features" class="relative border-t border-bone/[0.06] py-14 lg:py-[72px]">
    <div class="relative mx-auto max-w-7xl px-6 lg:px-10">
      ...
      <div class="mt-16 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 lg:mt-20">
        ...
        >
          <div
            class="panel relative grid grid-cols-1 gap-8 overflow-hidden rounded-3xl p-7 transition-colors duration-300 hover:border-azure/20 lg:grid-cols-2 lg:p-9"
          >
        ...
        >
          <div
            class="panel flex h-full flex-col gap-5 overflow-hidden rounded-3xl p-7 transition-colors duration-300 hover:border-azure/20"
          >
            <div>
